...
class model(nn.Module):
    def __init__(self, num_classes):
        ...
        self.lstm1 = nn.LSTM(input_size=3, hidden_size=128, num_layers=1,batch_first=True, bidirectional=True)
...
np.save('./res/BiLSTMloss.npy',losslist)
np.save('./res/BiLSTMacc.npy',acclist)
