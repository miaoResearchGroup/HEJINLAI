...
class model(nn.Module):
    def __init__(self, num_classes):
        ...
        self.conv1 = nn.Conv1d(3, 64, kernel_size=5, stride=1)  # padding也可以是tuple:(1,2)，#【输入信号的通道，卷积产生的通道(卷积核个数)，卷积核尺寸，卷积步长】，输入：【batch_size，信号维度，信号的最大长度】
        self.conv2 = nn.Conv1d(64,128, kernel_size=5, stride=1)  # padding也可以是tuple:(1,2)，
        self.conv3 = nn.Conv1d(128,64, kernel_size=5, stride=1)
...
np.save('./res/LSTMloss.npy',losslist)
np.save('./res/LSTMacc.npy',acclist)
